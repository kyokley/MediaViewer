...
class TestNew:
    ...
    def test_(self):
        new_file = File.new("test_filename", self.path)
...
class TestDestroyPosterFile:
    @pytest.fixture(autouse=True)
    def setUp(self, mocker):
        self.mock_get = mocker.patch("mediaviewer.models.file.PosterFile.objects.get")

        self.mock_log = mocker.patch("mediaviewer.models.file.log")
        ...
        self.file = File.new("test_filename", self.path)
...
class TestProperty:
    ...
    def setUp(self, mocker):
        ...
        self.another_path = Path.objects.create(
            localpathstr="local_another_path",
...
class TestDownloadLink:
    ...
    def setUp(self, mocker):
        ...
        mocker.patch("mediaviewer.models.file.LOCAL_IP", "test_local_ip")

        mocker.patch("mediaviewer.models.file.BANGUP_IP", "test_bangup_ip")

        self.mock_conf_settings = mocker.patch("mediaviewer.models.file.conf_settings")
...
class TestMoviesOrderedByID:
    ...
    def setUp(self):
        ...
        self.hidden_tv_file = File.new("hidden.tv.file", self.tv_path, hide=True)
        ...
        self.hidden_movie_file = File.new(
            "hidden.movie.file", self.movie_path, hide=True
        )

    def test_movie_files(self):
        expected = [self.movie_file2, self.movie_file]
