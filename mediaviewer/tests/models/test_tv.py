...
def test_episodes(
    create_tv, create_movie, create_tv_media_file, create_movie_media_file
):
    tv1 = create_tv()
    tv2 = create_tv()
    ...
    for movie in (movie1, movie2, hidden_movie):
...
class TestLastCreatedEpisodeAt:
    def test_last_created_episode_at(self, create_tv, create_tv_media_file):
        self.tv = create_tv()
    ...
    def test_no_lastCreatedFileDate(self, create_tv):
        self.tv = create_tv()
...
def test_delete(create_tv, create_tv_media_file):
    ...
    tvs = [create_tv_media_file(tv=tv) for i in range(5)]
    tv_mp = tv.media_path

    another_tv = create_tv()
    another_tvs = [create_tv_media_file(tv=another_tv) for i in range(5)]
