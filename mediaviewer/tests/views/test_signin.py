...
class TestSignin(TestCase):
    ...
    def test_request_not_POST(self):
        ...
        self.mock_render.assert_called_once_with(
            self.request, "mediaviewer/signin.html", expected_context
        )
        self.assertEqual(ret_val, self.mock_render_return)
    ...
    def test_request_POST_valid_user(self):
        ...
        self.request.GET = {}
        self.request.POST = {"username": "a@b.c", "password": "abc123"}
        self.mock_case_insensitive_authenticate.return_value = self.authenticated_user
        ...
        self.assertEqual(ret_val, self.mock_redirect)
