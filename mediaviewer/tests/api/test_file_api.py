...
class MovieFileViewSetTests(APITestCase):
    ...
    def test_get_moviefiles_by_pathid(self):
        response = self.client.get(reverse('mediaviewer:api:movie-list'),
    ...
    def test_create_moviefile_using_tvpath(self):
        ...
        response = self.client.post(reverse('mediaviewer:api:movie-list'),
                                    self.data)
    ...
    def test_update_valid_moviefile(self):
        ...
        response = self.client.put(reverse('mediaviewer:api:movie-detail',
...
class TvFileViewSetTests(APITestCase):
    ...
    def test_get_tvfiles_by_pathid(self):
        response = self.client.get(reverse('mediaviewer:api:tv-list'),
    ...
    def test_create_tvfile_using_tvpath(self):
        ...
        response = self.client.post(reverse('mediaviewer:api:tv-list'),
                                    self.data)
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
    ...
    def test_update_valid_tvfile(self):
        ...
        response = self.client.put(reverse('mediaviewer:api:tv-detail',
                                           args=[self.tvFile.id]), self.data)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
